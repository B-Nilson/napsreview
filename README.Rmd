...
In addition, city names are inconsistently spelled between files -  see [here](inst/extdata/issues/wrong_precision_coord_sites.csv) for the full list
...
For some sites/files, the coordinates are outside of the province/territory they are marked to be in - for some it appears to be a typo or rounding issue, but for a few it is a complely invalid longitude. See [here](inst/extdata/issues/out_of_province_coords.csv) for the full list of issues.
