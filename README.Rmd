...
For example, lat/lng values have differ between files causing slight/major shifts in location - see [here](inst/extdata/issues/multiple_loc_sites.csv) for the full list.
